...
function s.thfilter(c)
	return c:IsSetCard(0x100a) and c:IsMonster() and c:IsLevelAbove(5) and c:IsAbleToHand()
end
...
function s.thfilter2(c)
	return c:IsSetCard(0x65) and c:IsSpellTrap() and c:IsAbleToHand()
end
...
function s.cfilter(c)
	return c:IsFacedown() or not c:IsSetCard(0xa)
end
